...
* **Package name:** Nawagate
* **Rental Per month:** 324.50
...
- (a) Insertion of a new regulation after existing regulation 4 setting out all documentation and information to be submitted to the Authority together with the application form provided by the Authority for consideration thereof when applying for a class Network Facilities.
