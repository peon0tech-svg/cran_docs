...
### CONTENTS
**GENERAL NOTICE**
No. 24: Communication Regulatory Authority of Namibia: Regulations Prescribing Regulations on Reporting Obligations for Licensees: Communications Act, 2009 — Page 1
...
### REGULATIONS PRESCRIBING REGULATIONS ON REPORTING OBLIGATIONS FOR LICENSEES: COMMUNICATIONS ACT, 2009
...
10. All licensees must retain the information required to complete the reports and returns required in terms of these Regulations for a minimum of 36 months after the end of the reporting period, or for a longer time period as may be directed by the Authority.
...
(2) If after the measures set out in subregulation (1) above, the licensee still fails to submit the information requested, the Authority will deal with the matter in terms of section 114, 115 and 116 of the Act and the Penalty Regulations published under General Notice No. 159 of 29 April 2020.
...
| GDP Contribution | GDP Operating Expenses total Reported |
...
### BI-ANNUAL DATA REQUIREMENTS FOR TELECOMMUNICATION LICENSEES
...
| | Tower Height (m) |
| | Building Height (m) |
| | OPEX per month (N$) (excluding colocation costs) |
| Technology | 2G |
| | 3G |
| | 4G |
| | CDMA |
...
### ANNUAL DATA REQUIREMENTS FOR TELECOMMUNICATION LICENSEES
...
### BI-ANNUAL DATA REQUIREMENTS FOR BROADCASTING LICENSEES

| Category | Indicator/KPI |
|---|---|
| Quality of service | Supply time for subscription-based television service connections within 5 elapsed days percent |
...
### ANNUAL DATA REQUIREMENTS FOR BROADCASTING LICENSEES
...
| | Number of letter boxes (P O Boxes) |
...
### BI-ANNUAL DATA REQUIREMENTS FOR POSTAL LICENSEES
