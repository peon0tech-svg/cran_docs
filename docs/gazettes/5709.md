...
## TARIFFS FOR BIZSAT (VSAT) BY MTN BUSINESS SOLUTIONS (PTY) LTD
...
| UPLOAD SPEED | DOWN LOAD SPEED | 2 YEAR | CAPPING |
| :--- | :--- | :--- | :--- |
...
In light thereof, the Authority approved the BIZSAT (VSAT) Products as submitted by MTN Business Solutions (Namibia) (Pty) Ltd.
