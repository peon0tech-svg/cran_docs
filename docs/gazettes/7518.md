...
* [No. 155 Communications Regulatory Authority of Namibia: Notice in terms of the Regulations Regarding the Submissions of Interconnection Agreements and Tariffs](#no-155) (Page 8)
...
#### No. 154 <a name="no-154"></a> (2021)

**NOTICE OF INTENTION TO AMEND THE REGULATIONS PRESCRIBING THE NATIONAL NUMBERING PLAN FOR USE IN THE PROVISION OF TELECOMMUNICATIONS SERVICES IN THE REPUBLIC OF NAMIBIA, NUMBERING LICENCE FEES AND PROCEDURES FOR NUMBER LICENCES: COMMUNICATIONS ACT, 2009**
...
Annual Number Fee = number × weight × reference value
...
There are a number of reasons why the cost per number increased:
...
| **Source:** | [zicta.zm](https://www.zicta.zm/storage/posts/attachments/0r9W6SdgD02vUW4N7D8k5NlA9dDCeVDexQDHFzx8.pdf) | |
...
* For resource user’s individually assigned number blocks, the payable annual fees shall be calculated as per equation below:  
  $F_A = B \times C$  
  where $F_A$ is the annual numbering fee to be paid by resource user, $B$ is the total number block assigned, allocated to the resource user, $C$ is the fee for each subscriber number in the assigned number block allocated to the resource user.
...
* OECD (1995-01-01), “The Economic and Regulatory Aspects of Telecommunication Numbering”, *OECD Digital Economy Papers*, No. 12, OECD Publishing, Paris. [DOI Link](http://dx.doi.org/10.1787/237502514428)
* [potraz.gov.zw/?p=80](http://www.potraz.gov.zw/?p=80)
* [tcra.go.tz: Application Guidelines and Fees for Numbering Resources - April 2018](https://www.tcra.go.tz/document/Application%20Guidelines%20and%20Fees%20for%20Numbering%20Resources%20-%20April%202018)
* [zicta.zm: ZICTA Numbering Plan Fees](https://www.zicta.zm/storage/posts/attachments/0r9W6SdgD02vUW4N7D8k5NlA9dDCeVDexQDHFzx8.pdf)

***

## COMMUNICATIONS REGULATORY AUTHORITY OF NAMIBIA

#### No. 155 <a name="no-155"></a> (2021)
...
| Package | 24 Months - Total ex VAT (N$) | 24 Months - VAT Incl (N$) | 36 Months - Total ex VAT (N$) | 36 Months - VAT Incl (N$) |
|---|---|---|---|---|
